      ...
      <div className = "flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage : 'url(/main-bg.webp)'}}>
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
         ...
         <p className="text-gray-200 hidden md:block">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, consequuntur mollitia sequi eum minus dolore? Eum ipsum voluptatum cupiditate, beatae ea, deserunt aliquid, laboriosam culpa nemo veniam esse. Incidunt, deserunt!
         </p>
